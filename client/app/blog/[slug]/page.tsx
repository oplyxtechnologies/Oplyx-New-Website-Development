    ...
    <main className="bg-[#0a0d12] text-white py-16 px-6 md:px-12">
      <div className="max-w-7xl mt-20 mx-auto grid md:grid-cols-[2fr_1fr] gap-12">
        <article>
          ...
          <div className="space-y-4 leading-relaxed text-white/80 mb-10">
          ...
          <div className="border-t border-white/10 pt-6">
            ...
            <div className="flex gap-4">
              <a
                href={`https://www.facebook.com/sharer/sharer.php?u=https://www.oplyx.tech/blog/${blog.slug}`}
                target="_blank"
                rel="noopener noreferrer"
                className="hover:underline text-[#7feccf]"
              >
                Facebook
              </a>
              <a
                href={`https://twitter.com/intent/tweet?url=https://www.oplyx.tech/blog/${
                  blog.slug
              ...
              <a
                href={`https://www.linkedin.com/sharing/share-offsite/?url=https://www.oplyx.tech/blog/${blog.slug}`}
                target="_blank"
                rel="noopener noreferrer"
                className="hover:underline text-[#7feccf]"
              >
        ...
        <aside className="space-y-6">
          ...
          {others.map((b) => (
            <Link key={b.slug} href={`/blog/${b.slug}`}>
              <div className="border-b border-white/10 pb-4 mb-4 hover:opacity-80 transition">
                ...
                <p className="text-white/60 text-sm">{b.excerpt}</p>
              </div>
            </Link>
          ))}
          ...
          <div className="mt-10 p-6 bg-white/5 rounded-lg border border-white/10">
            ...
            <Link href="/contact">
              <button className="px-4 py-2 bg-[#7feccf] text-black rounded hover:bg-[#65ddbc]">
                Contact Us
              </button>
            </Link>
          </div>
