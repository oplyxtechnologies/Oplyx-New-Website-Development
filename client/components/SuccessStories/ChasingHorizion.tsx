      ...
      <main className="text-white">
        ...
        <section className="py-20 px-6 md:px-12 max-w-5xl mx-auto text-center">
          ...
          <p className="text-white/80 mb-4">
            ...
            travelers search, compare, and book flights, hotels, and activities
            in one smooth flow. We crafted a clean UI, powerful search
            integrations, and intuitive booking experience.
          </p>
        ...
        <section className="px-6 md:px-12 max-w-6xl mx-auto mb-20 space-y-20">
          ...
          <div className="md:flex gap-12 items-center md:flex-row-reverse">
            ...
            <div>
              ...
              <p className="text-white/80">
                Clean cards showcase the most visited cities & packages — easy
                to explore & compare.
              </p>
            </div>
          </div>
        ...
        <section className="py-20 px-6 md:px-12 text-center max-w-3xl mx-auto">
          <blockquote className="italic text-xl text-white/80 mb-4">
            “Working with Oplyx made it so easy to launch a polished booking
            site. Customers love it, and we&apos;ve seen great growth.”
          </blockquote>
...
export default ChasingHorizion;
